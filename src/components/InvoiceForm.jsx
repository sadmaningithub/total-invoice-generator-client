...
export default function InvoiceForm() {
  ...
  const handleAddField = () => {
    const newField = { item: '', quantity: '', unitPrice: '', amount: '' };
    ...
    <div className="min-h-screen bg-base-200 p-5">
      ...
      <form onSubmit={handleItemsSubmit} className=" md:max-w-1/2 mx-auto bg-white shadow-xs rounded-lg border border-gray-200 p-5 ">
        ...
        <div className="mb-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-gray-700 ">
            ...
            <div className="flex flex-col">
              <label> Name</label>
              <input className="input w-full bg-base-200" placeholder="Name" type="text" />
            </div>
        ...
        <div className="mb-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-gray-700">
            ...
            <div className="flex flex-col gap-3">
              ...
              <select defaultValue="Choose currency" className="select w-full bg-base-200">
            ...
            <div className="flex flex-col gap-3">
              ...
              <input className="input w-full bg-base-200" type="date" />
            </div>
        ...
        <div>
          ...
          {
            inputFields.map((input, index) => (<div key={index} className="grid grid-cols-1 md:grid-cols-6 gap-5 mb-5 text-gray-700 border border-red-300">
              ...
              <div className="flex flex-col">
                <label>Amount</label>
                <input className="input w-full bg-base-200" name="amount" value={input.amount} readOnly type="number" />
              </div>
        ...
        <div className="mb-5 flex flex-row justify-end">
          <div className="flex flex-col gap-5">
            <div className="flex flex-row items-center gap-2">
              ...
              <input className="input" name="total" type="" />
            </div>
            <div className="flex flex-row items-center gap-2">
